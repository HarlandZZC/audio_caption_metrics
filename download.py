...
from audio_caption_metrics.functional.meteor import DNAME_METEOR_CACHE
from audio_caption_metrics.functional.spice import (
    DNAME_SPICE_CACHE,
    DNAME_SPICE_LOCAL_CACHE,
    FNAME_SPICE_JAR,
    check_spice_install,
)
from audio_caption_metrics.utils.cmdline import _str_to_bool
from audio_caption_metrics.utils.globals import (
    _get_cache_path,
    _get_tmp_path,
    get_default_cache_path,
    get_default_tmp_path,
)
from audio_caption_metrics.utils.log_utils import setup_logging_verbose
from audio_caption_metrics.utils.tokenization import FNAME_STANFORD_CORENLP_3_4_1_JAR
